...
class Processor():
    ...
    def train(self, epoch, save_model=False):
        ...
        for batch, (data, label, sample) in enumerate(tqdm(self.data_loader['train'], desc="Training", ncols=40)):
            self.global_step += 1
            with torch.no_grad():
    ...
    def eval(self, epoch, save_score=False, loader_name=['test'], wrong_file=None, result_file=None):
        ...
        for ln in loader_name:
            ...
            label_list = []
            pred_list = []
            for batch, (data, label, sampie) in enumerate(tqdm(self.data_loader[ln], desc="Evaluating", ncols=40)):
            ...
            if save_score:
                with open('{}/epoch1_test_score.pkl'.format(self.arg.work_dir), 'wb') as f:
